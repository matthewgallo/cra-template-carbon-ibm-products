...
export const DatagridExample = () => {
  ...
  const columns = useMemo(() => defaultHeader, [defaultHeader]);
  ...
  return (
    <div className="datagrid-example-container">
      <p className="intro-text"><CodeSnippet hideCopyButton type="inline">create-react-app</CodeSnippet>starter template</p>
